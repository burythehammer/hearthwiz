Feature: Card details
  ...
  Background:
    Given the card 'Card A' exists

  Scenario: Card can be navigated to from direct id links
    When I navigate to the card page for 'Card A'
    Then the card page of 'Card A' should have the correct title

  Scenario: When browsing to a card with unknown id

    When I navigate to an invalid card page
  ...
  Scenario Outline: Card title
    ...
    Given the card '<card-name>' exists
