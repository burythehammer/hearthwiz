Feature: Card Page
	...
	Then I should be on the 'Reincarnate' card page
		...
		And the card page tells me it costs '2' mana
	...
	Then I should be on the 'Deathlord' card page
		...
		And the card page tells me it costs '3' mana
		And the card page tells me it has '8' health
		And the card page tells me it has '3' attack
	...
	Then I should be on the 'Death's Bite' card page
		...
		And the card page tells me it costs '4' mana
		And the card page tells me it has '2' durability
		And the card page tells me it has '4' attack
